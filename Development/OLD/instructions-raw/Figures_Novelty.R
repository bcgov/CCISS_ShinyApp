...
clim.targets <- clim.grid[PERIOD == list_gcm_periods()[4], ]
...
ccissr::analog_novelty(clim.targets = clim.targets,
...
novelty <- ccissr::analog_novelty(clim.targets = clim.targets,
                          clim.analogs = clim.pts,
                          label.targets = bgc.pred,
                          label.analogs = clim.pts$BGC,
