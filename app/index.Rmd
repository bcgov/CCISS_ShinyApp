...
###### 2. Upload a CSV File contain points of interests

Upload a csv file with columns named ID1, Latitude, and Longitude (negative values) will your points of interest.
...
###### 3. Generate summary using preselected points by:
Choose option to use points across an entire BGC subzone/variant or on points in a Forest District by BGC
...
splitLayout(actionButton("clear_highlight","Clear Selections"),
