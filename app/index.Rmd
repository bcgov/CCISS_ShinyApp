...
To edit location information, double click a row.  
Hit Generate/Refresh Button at bottom to run projects.
...
selectInput("bgc_spatial_period",label = "Period:",choices = c("Current" = 1991,"2021-2040" = 2021, "2041-2060" = 2041, "2061-2080" = 2061, "2081-2100" = 2081),selected = 1991)
```
