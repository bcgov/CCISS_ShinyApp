...
```{r}
# Actions on points
actionButton("upload_button", "Upload", icon("upload"), width="129px")
actionButton("add_dialog", "Add", icon("plus"), width="129px")
actionButton("delete_button", "Delete", icon("trash-alt"), width="129px")
actionButton("clear_button", "Clear", icon("broom"), width="129px")
