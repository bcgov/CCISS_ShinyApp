...
-   **Biogeoclimatic (BGC) units** are a specific type of bioclimate unit
...
-   The **site series** describes the site-level ecological variability
    ...
    made during plot collection to determine relative position on
    ...
    BGC unit allows the linkage of equivalent site concepts between BGC 
    units in climate change modelling at a stand-level (i.e.
...
Archibald, J.H., G.D. Klappstein, and I.G.W. Corns. 1996. Field guide to ecosites 
of southwestern Alberta. Special Report 8. Natural Resources Canada, Canadian 
Forest Service, Northwest Region, Northern Forestry Centre, Edmonton, Alberta. 
