...
located in the modelled climate areas, descriptions available in
publications describing forest associations or ecosites, and available
...
-    Not all site conditions of the site series may be suitable for
    successful establishment/regeneration. o Species success is reduced
...
-   Climatic extremes have a higher probability of causing reduced
    growth, damage or mortality (e.g. drought periods, snow damage,
...
**E4 -- Not Suitable**: Species is outside of its environmental
tolerance range.
...
ratings for BC and Western North America can be found on the BC Data Catalogue [BCDC](https://catalogue.data.gov.bc.ca/dataset/1810fdca-8762-4d6a-8886-4e8cefbdb640)
...
tree species assigned to the highest suitability rating. **DISCLAIMER**:
Insect and disease risks need to be considered in reforestation,
particularly in the context of climate change. These factors are
currently being assessed by Forest Health researchers but are not
directly incorporated into the historic ratings or CCISS environmental
