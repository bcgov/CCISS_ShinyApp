...
-   **Option 1**. Click on BGC map to add one or more individual
    ...
    are averaged within a BGC (default) or for each individual site.

-   **Option 2**. Click on map to choose an entire BGC or a BGC within a
...
Option 1 and 2 default to BGC averaged reports while option 3 defaults
...
### 3. Establishment feasibility weights
...
value is a weighted average of the environmental feasibility in the baseline
1961-1990, observed 2001-2020, and projected 2021-2040 periods. The default weightings are
...
in the ecosystem. Second, the observed 2001-2020 period reflects the actual
climate experienced in the location of interest. Third, the projected 2021=2040
...
visible in the detailed feasibility report. See Documentation - Methods - Rule Sets.  

### 4. Maturation feasibility weights
...
and assigns each of these models equal weighting. The five models were
excluded because their warming rates aren't supported by observational
