...
-	Maps of Tree species environmental suitability projections for three site types;
...
-	`Suitability Change` displays the change in suitability relative to the mapped reference period (1961-1990) suitability rating. Suitabilties in historically unsuitable locations are mapped in yellow to differentiate this suitability range expansion from increases in suitability within the historically suitable range of the species. 
...
<figure>
  <img src="Figure_2f_FindABEC.png" alt="" style="width:60%;">
</figure>
