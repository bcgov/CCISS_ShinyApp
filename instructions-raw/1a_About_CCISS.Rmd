...
The following BC Ministry of Forests ecologists provided regional environmental suitability ratings for tree species: Allen Banner (ret.), Ray Coupe (ret.), Del Meidinger (ret.), Tom Braumandl (ret.), Bob Green (ret.), Bruce Rogers (dec.), Heather Klassen, Sari Saunders, Deb MacKillop, Hardy Griesbauer, and Daniel Sklar. 
