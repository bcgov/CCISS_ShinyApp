...
<p style="margin-left: 2em;"> These definitions differ from the environmental suitability definitions used in the CCISS tool. For these, see Definitions - Suitability Definitions. For more information about Ecological suitability for a timber objective, see, for example, this report from the [Cariboo Forest Region](https://www2.gov.bc.ca/assets/gov/farming-natural-resources-and-industry/forestry/silviculture/stocking-standards/efgg/efg-car-print.pdf).</p>
