...
report provides a comparison of the Chief Forester's Reference Guide (CFRG), the Environmental suitability rating (expert derived) and the CCISS suitability assessment at establishment and maturity. The
Detailed mode shows the distribution of suitability ratings for the
global climate model ensemble in each time period.

The concept and definitions of Environmental suitability ratings and their relationship to Stocking Standards (CFRG) and CCISS model projections are discussed
in more detail <a href="3c_SuitabilityRatings.html">here</a>.
...
that meet the threshold for classification as suitable across the global
...
suitability ratings is on the left hand pane. The mapped biogeoclimatic
...
The report then summarizes the historic suitability ratings and CCISS
forecasted suitability ratings for each species in the following order:
...
4.  **CCISS Establishment Suitability**: The suitability rating based on
    the historic environmental suitability (1961-1990), and CCISS forecasted suitability based on recent      observed (2001-2020), and 2021-2040 future projected climates. This indicates the likely level of
    constraints for successful establishment of the species in the
    present climate. Default model settings give roughly equal weight to the three time periods, with         slightly more weight to the recent (2001+) periods.
...
are strike-through.*Note these are not formally adopted stocking standards by BC Ministry of Forests. 
