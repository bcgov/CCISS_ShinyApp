...
If we return to the bar chart, under the "Mapped" bar, we see the two bars that represent the recent time period (2001-2020). From this, we can see that the weather station data and the climates simulated by the ensemble of GCMs are in agreement. We can see that although some GCM runs predicted that 

The CCISS tool gives the user a way to evaluate the future environmental suitability of a species in an area. As such, the  
