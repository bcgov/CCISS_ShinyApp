...
each with their own sources of error. Understanding these sources of
error can help users determine appropriate uses for CCISS projections.
...
plot data. There are inevitably errors in this knowledge base. Errors in
feasibility ratings are most likely in species that were not
...
to evaluate and refine feasibility ratings. 
...
review and revisions of the CCISS feasibility tables. This example shows
feasibility ratings for western redcedar on zonal sites, with editing
for the CWHdm open.
...
vs. cold aspects) and lake effects. Because they are absent from the
CCISS analysis, microclimatic factors need to be accounted for as a part
of professional interpretation of CCISS results.
...
in the climate mapping." style="width:70%;"/>
...
differences in warming rate due for example to changes in snowpack.
...
FFEC’s ClimatEx project seeks to improve the spatial resolution of
