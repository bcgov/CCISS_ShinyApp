...
rich/hygric (D6) site types across all BGCs. Providing spatial data for all 35 edatopes would be too computationally feasible, so we chose these three edatopes to represent distinct, common site types. 
Although it is typical to place SMR first in edatope names (e.g., 4C), we put SNR first because it is much more convenient in computer code. 
