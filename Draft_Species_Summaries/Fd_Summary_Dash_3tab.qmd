...
Douglas-fir (Fd) is native to the Pacific and Cordilleran regions of Western North America. In BC there are two varieties, interior Douglas-fir (*Pseudotsuga menziesii* var. *glauca*) found throughout the Central and Southern Interior and coastal Douglas-fir (*Pseudotsuga menziesii* var. *menziesii*) found along the south coast and Vancouver Island. It is most common in the montane zone, but also occurs in the submontane zone and to a lesser extent subalpine zone [@klinka_distribution_2000].  For the purposes of these analyses and figures, we do not distinguish between the two varieties of Fd.
...
#| out-height: 100%
#| padding: 0px
#| fig-cap: On poor/subxeric sites Fd environmental suitability is moderate to low (E2 to E3) throughout the Central and Southern Interior. Suitability is high (E1) on  poor/subxeric sites bordering the Strait of Georgia and on the lower slopes of the southern Columbia Mountains and Rocky Mountain Trench. Remaining areas (in white) are unsuitable for Fd under historic climates on poor/subxeric sites.
...
#| out-height: 100%
#| padding: 0px
#| fig-cap: Fd has a much more limited range on rich/hygric sites overall and environmental suitability is mostly moderate to low (E2-E3). Suitability is moderate (E2) around the Georgia Basin (CWHdm1) and mid slopes of the Okanagan Valley (e.g., IDFdm1) and low (E3) on rich/hygric sites of the Eastern Okanagan –Shuswap and Southern Interior Mountains. Smaller areas of high (E1) suitability exist on rich/hygric sites of the Rocky Mountain Trench (IDFdk5) and southern Vancouver Island (CDFmm). Remaining areas (in white) are unsuitable for Fd under historic climates on rich/hygric sites.
...
::: card
Douglas-fir (Fd) is projected to persist within 70-90% of its historically suitable range under climate change depending on site type. In addition, the suitable range of Fd is projected to expand over time into an area 1.5 - 2 times the size (150-200%) of its historical range. The projected expansion of Fd's suitable area is driven by warming temperatures, for example portions of the Engelmann Spruce--Subalpine Fir (ESSF) and Montane Spruce (MS) zones becoming warmer and therefore more suitable for Fd. <br>
...
Note that the D6 edatope (rich/hygric site type) makes up a smaller area proportionally of the total range of Fd in BC when compared to C4 or B2 sites. In addition, historical suitability is low (E3) on most D6 sites, and the total area suitable to Fd on these sites is projected to slightly increase with net gains in the CWH, MS and MH zones to the end of the century. 
