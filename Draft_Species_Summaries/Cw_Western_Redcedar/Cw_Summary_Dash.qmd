...
Welcome to the Species Summary Dashboard for Western Redcedar (abbreviated as "Cw"), a place for species-specific summaries of the CCISS data. This dashboard is intended to support forest practitioners, planners, and land managers, in making informed, forward-looking decisions about where Redcedar may be suitable to plant over the coming decades. As climate conditions shift, these decisions will become increasingly critical for maintaining productive, resilient, and adaptive forest landscapes.

At the top of the page, you will find tabs for the following summaries:

-   **Reference (historical baseline) Range**
    -   Maps and descriptive summary of the species range in British Columbia during the baseline climate normal period of 1961-1990 in terms of its environmental suitability across Biogeoclimatic (BGC) zones and across three edatopic (soil nutrient x moisture) regimes, relative to the local biogeoclimatic zone:
        -   Poor/subxeric (B2)
        -   Mesic/zonal (C4)
        -   Rich/hygric (D6)
...
Redcedar is best adapted to climates with abundant precipitation and high humidity but can tolerate a range of conditions. In BC, Redcedar is most commonly found in cool and cold mesothermal climates on the coast and in montane continental cool temperate climates in the interior wet belt (Klinka and Brisco 2009). The species grows across a wide variety of soil types, but is most productive on fresh to moist, nutrient-rich soils (Klinka and Brisco 2009).
...
In the maps below, each color represents the species climatic suitability documented during the historical reference period* of 1961-90. Green represents high suitability (E1 rating), blue represents moderate suitability (E2), yellow represents low suitability (E3), and white indicates areas that are unsuitable for the species (EX).
...
The pie chart to the right shows the proportional cover (Km^2^) of Western Redcedar across the BGC zones that it was documented in during the historical reference period (1961-1990).
...
The most notable pattern observed in the interior of BC is the expansion of suitability in the sub-boreal, as ICH-like (Interior Cedar - Hemlock) climates are projected to spread northward and westward into the Sub-Boreal Spruce (SBS) zone. In the historical reference period (1961-1990), the area between roughly Smithers and Prince George including the whole Interior Plateau was unsuitable for Redcedar. CCISS projections suggest that much of this area will not only become suitable, but may even become moderately (E2) to highly (E1) suitable by 2100. 

There are also some locations in the southeast that are currently Engelmann Spruce - Subalpine Fir (ESSF) or Montane Spruce (MS) zones, which will transition to be more like ICH in the near future, making them newly suitable for Western Redcedar. ESSF is the subalpine zone above the ICH, so this will likely represent cases of Redcedar suitability moving upslope as the habitat becomes more favorable.

Meanwhile, many parts of the Coastal Western Hemlock (CWH) and ICH zones where suitability was high during the reference period are projected to decrease in suitability and even become fully unsuitable as these areas become more climatically similar to drier and/or warmer southern zones in Washington, Oregon, and California. However, in many of its most suitable habitats along the coast (e.g., with an E1 suitability ranking) there is little projected change in suitability. This is likely because climatic consistency in these subzones will continue to be maintained by coastal upwelling and weather patterns.
...
In mesic/zonal and rich/hygric sites, where higher amounts of soil moisture and nutrients are more suitable for Redcedar, some novel expansion into the Boreal White and Black Spruce (BWBS), IDF, MS, and Sub-Boreal Pine - Spruce (SBPS) zones is also projected as these zones become warmer and wetter over time.
...
This figure shows that Western Redcedar is overall projected to persist within about 40-60% of its historically suitable range (depending on SSP scenario), while its expanded range is projected to be about 1-1.5 times larger. Range expansion is projected to be progressively higher under the increased warming scenarios of SSP245 and SSP370. 
These trends are similar across the three edatopes, which are shown to be clustered tightly together for this species. This suggests that within a BGC zone, populations of Redcedar in different edatopes will respond similarly to climate change.
