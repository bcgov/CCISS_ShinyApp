...
These patterns are shown in 20-year intervals and by Edatopic space in the figures below.
...
## Row - Suitability area: alluvial plots
...
The figure on the right shows the overall projected persistence and expansion of the suitability of Western Redcedar relative to its historically suitable range, in the SSP2-4.5 scenario given current policies for moderate emission mitigation.
