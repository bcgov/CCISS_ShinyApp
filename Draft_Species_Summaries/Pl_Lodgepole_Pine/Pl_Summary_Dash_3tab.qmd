...
fig_path <- "./Figures" #Since this qmd file is in the Pl_Western_Redcedar folder, the Figures folder also has to be inside Pl_Western_Redcedar. This means that in ccissr, it will make the most sense to create a species-specific figure folder, to then copy/paste into the specific species dashboard folders here.
