...
Welcome to the Species Summary Dashboard for Douglas Fir (abbreviated as "Fd"), a place for species-specific summaries of the inputs and outputs of the Climate Change Informed Species Selection (CCISS) tool. This dashboard is intended to support forest practitioners, planners, and land managers, in making informed, forward-looking decisions about where Fd may be suitable to plant over the coming decades. As climate conditions shift, these decisions will become increasingly critical for maintaining productive, resilient, and adaptive forest landscapes.
...
This dashboard is intended to provide a species-specific overview and interpretation of the data from the CCISS tool and does not represent management recommendations. Fdease see the CCISS Documentation tab \> Decision Guidance section for more information on the appropriate and intended uses of these data.

For Douglas Fir, ...summarize.
...
How is the total environmentally suitable area of the province (all colored areas on the maps) split across Biogeoclimatic (BGC) zones? The pie chart to the right explores this by showing the total suitable area (Km^2^) of BC for Douglas Fir by BGC zone based on climates of the historical reference period (1961-1990).
...
**CCISS projections for Douglas Fir**
