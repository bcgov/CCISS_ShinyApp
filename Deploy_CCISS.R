...
analogsea::droplet_upload(server, "./app/htmlwidgets", "/srv/shiny-server/ccissdev")
...
analogsea::droplet_upload(server, c("./app/cciss_metadata.csv","./app/README.txt"), "/srv/shiny-server/ccissdev")
analogsea::droplet_ssh(server, "chown -R shiny:shiny /srv/shiny-server")
analogsea::droplet_ssh(server, "systemctl restart shiny-server")